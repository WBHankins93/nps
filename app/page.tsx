...
export const metadata: Metadata = {
  ...
  description: "Expert pool maintenance, equipment repair, and renovation services in New Orleans. Licensed, insured, and community-trusted. Serving Greater New Orleans & Northshore. Get your free quote today!",
  openGraph: {
    title: "Premium Pool Services in New Orleans | NOLA Pool Solutions",
