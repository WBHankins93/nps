      ...
      <div className="relative z-10 flex h-full flex-col px-6 py-8 text-white md:px-10 lg:px-16">
        <header className="mb-6 space-y-3 md:mb-8 md:space-y-4">
          ...
          <h1 className="text-3xl font-bold md:text-4xl lg:text-5xl">
            Let’s plan your next pool visit
          </h1>
        ...
        <div className="grid flex-1 gap-6 md:grid-cols-[1.05fr_0.95fr] md:gap-8">
          <div className="flex flex-col justify-between rounded-3xl border border-white/15 bg-white/10 px-6 py-6 backdrop-blur-md md:px-8 md:py-8">
            ...
            <div className="mt-6 rounded-2xl bg-white/8 p-4 text-sm leading-relaxed text-white/75 md:text-base">
          ...
          <div className="rounded-3xl border border-white/15 bg-white/90 px-6 py-6 text-[#0B1F3F] shadow-xl backdrop-blur md:px-8 md:py-8">
            <h2 className="text-xl font-semibold md:text-2xl">
              Start the conversation
            </h2>
            <p className="mt-2 text-sm leading-relaxed text-[#536471] md:text-base">
            ...
            <form className="mt-6 grid gap-4 md:gap-5">
              ...
              <div className="flex items-center justify-between">
                <p className="text-xs text-[#536471] md:text-sm">
